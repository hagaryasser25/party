...
class CoordinatorLogin extends StatefulWidget {
  static const routeName = '/coordinator_login';
  const CoordinatorLogin({Key? key}) : super(key: key);

  IconData? get icon => Icons.lock;

  @override
  State<CoordinatorLogin> createState() => _CoordinatorLogin();
}

class _CoordinatorLogin extends State<CoordinatorLogin> {
